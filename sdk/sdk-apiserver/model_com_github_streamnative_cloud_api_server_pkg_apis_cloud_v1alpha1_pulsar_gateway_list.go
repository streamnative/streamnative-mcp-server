...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGateway `json:"items"`
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList(items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGateway) *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList{}
	this.Items = items
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGateway {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGateway
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarGatewayList) UnmarshalJSON(src []byte) error {
	v.isSet = true
