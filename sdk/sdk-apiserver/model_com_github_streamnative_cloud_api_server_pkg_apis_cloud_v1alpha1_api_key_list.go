...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey `json:"items"`
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyList) UnmarshalJSON(src []byte) error {
	v.isSet = true
