...
// ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription Subscription is the Schema for the subscriptions API This object represents the goal of having a subscription. Creators: self-registration controller, suger webhook Readers: org admins
type ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SubscriptionStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) Get() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) Set(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1Subscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
