...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember `json:"items"`
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberList) UnmarshalJSON(src []byte) error {
	v.isSet = true
