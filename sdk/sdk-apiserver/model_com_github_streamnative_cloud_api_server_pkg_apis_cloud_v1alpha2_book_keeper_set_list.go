...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSet `json:"items"`
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSet {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSet
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2BookKeeperSetList) UnmarshalJSON(src []byte) error {
	v.isSet = true
