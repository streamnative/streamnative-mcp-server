...
// ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview SugerEntitlementReview is a request to find the organization with entitlement ID.
type ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReviewStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) Get() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) Set(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1SugerEntitlementReview) UnmarshalJSON(src []byte) error {
	v.isSet = true
