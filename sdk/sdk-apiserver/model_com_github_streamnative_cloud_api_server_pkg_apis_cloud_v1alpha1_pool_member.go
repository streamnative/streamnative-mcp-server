...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember PoolMember
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMemberStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PoolMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
