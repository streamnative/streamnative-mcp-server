...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding `json:"items"`
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList(items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList{}
	this.Items = items
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingList) UnmarshalJSON(src []byte) error {
	v.isSet = true
