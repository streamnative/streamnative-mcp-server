...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding ServiceAccountBinding
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBindingStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountBinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
