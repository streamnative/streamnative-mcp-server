...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding RoleBinding
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBindingStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleBinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
