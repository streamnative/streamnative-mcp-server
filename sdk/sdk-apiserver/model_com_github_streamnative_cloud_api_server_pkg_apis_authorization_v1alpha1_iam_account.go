...
// ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount IamAccount
type ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) Get() *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) Set(val *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount(val *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
