...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role Role
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) UnmarshalJSON(src []byte) error {
	v.isSet = true
