...
func (r ApiGetCloudStreamnativeIoAPIGroupRequest) Execute() (*V1APIGroup, *http.Response, error) {
	return r.ApiService.GetCloudStreamnativeIoAPIGroupExecute(r)
}

/*
GetCloudStreamnativeIoAPIGroup Method for GetCloudStreamnativeIoAPIGroup
...
func (a *CloudStreamnativeIoApiService) GetCloudStreamnativeIoAPIGroupExecute(r ApiGetCloudStreamnativeIoAPIGroupRequest) (*V1APIGroup, *http.Response, error) {
	...
	localVarPath := localBasePath + "/apis/cloud.streamnative.io/"
