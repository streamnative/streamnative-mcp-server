...
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnectionStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1CloudConnection) UnmarshalJSON(src []byte) error {
	v.isSet = true
