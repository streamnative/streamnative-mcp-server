...
// ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer PublicOffer is the Schema for the publicoffers API
type ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOfferSpec `json:"spec,omitempty"`
	// PublicOfferStatus defines the observed state of PublicOffer
...
func NewComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer {
	this := ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOfferSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOfferSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOfferSpec and assigns it to the Spec field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) Get() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) Set(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PublicOffer) UnmarshalJSON(src []byte) error {
	v.isSet = true
