...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition(status string, type_ string) *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition{}
	this.Status = status
	this.Type = type_
	return &this
}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2Condition) UnmarshalJSON(src []byte) error {
	v.isSet = true
