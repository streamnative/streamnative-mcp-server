...
// ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock struct for ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock
type ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock {
	this := ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClockStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) Get() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) Set(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1TestClock) UnmarshalJSON(src []byte) error {
	v.isSet = true
