...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccount `json:"items"`
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList(items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccount) *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList{}
	this.Items = items
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccount {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccount
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ServiceAccountList) UnmarshalJSON(src []byte) error {
	v.isSet = true
