...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey APIKey
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeySpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeySpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeySpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeySpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKeyStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1APIKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
