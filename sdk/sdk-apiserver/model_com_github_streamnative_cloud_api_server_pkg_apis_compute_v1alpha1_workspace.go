...
// ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace Workspace
type ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1WorkspaceStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) Get() *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) Set(val *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace(val *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Workspace) UnmarshalJSON(src []byte) error {
	v.isSet = true
