...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding ClusterRoleBinding
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
