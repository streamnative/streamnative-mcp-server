...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role `json:"items"`
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList(items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role) *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList{}
	this.Items = items
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Role
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1RoleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
