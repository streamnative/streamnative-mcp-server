...
// ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest CustomerPortalRequest is a request for a Customer Portal session.
type ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequestStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) Get() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) Set(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1CustomerPortalRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
