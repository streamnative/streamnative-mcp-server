...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole ClusterRole
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRole) UnmarshalJSON(src []byte) error {
	v.isSet = true
