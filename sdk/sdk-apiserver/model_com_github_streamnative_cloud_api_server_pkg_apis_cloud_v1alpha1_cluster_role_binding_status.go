...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus ClusterRoleBindingStatus defines the observed state of ClusterRoleBinding
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus struct {
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1ClusterRoleBindingStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
