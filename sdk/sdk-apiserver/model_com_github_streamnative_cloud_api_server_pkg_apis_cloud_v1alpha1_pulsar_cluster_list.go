...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarCluster `json:"items"`
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList(items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarCluster) *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList{}
	this.Items = items
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarCluster {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarCluster
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1PulsarClusterList) UnmarshalJSON(src []byte) error {
	v.isSet = true
