...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList struct for ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool `json:"items"`
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolList) UnmarshalJSON(src []byte) error {
	v.isSet = true
