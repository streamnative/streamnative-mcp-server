...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration SelfRegistration
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistrationSpec `json:"spec,omitempty"`
	// SelfRegistrationStatus defines the observed state of SelfRegistration
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistrationSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistrationSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistrationSpec and assigns it to the Spec field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1SelfRegistration) UnmarshalJSON(src []byte) error {
	v.isSet = true
