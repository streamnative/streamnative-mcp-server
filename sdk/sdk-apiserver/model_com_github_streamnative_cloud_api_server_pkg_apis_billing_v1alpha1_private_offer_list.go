...
// ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList struct for ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList
type ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOffer `json:"items"`
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOffer {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOffer
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) Get() *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList(val *ComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisBillingV1alpha1PrivateOfferList) UnmarshalJSON(src []byte) error {
	v.isSet = true
