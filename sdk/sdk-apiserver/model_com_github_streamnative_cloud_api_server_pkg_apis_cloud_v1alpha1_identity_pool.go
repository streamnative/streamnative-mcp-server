...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool IdentityPool
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolStatus `json:"status,omitempty"`
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPoolStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1IdentityPool) UnmarshalJSON(src []byte) error {
	v.isSet = true
