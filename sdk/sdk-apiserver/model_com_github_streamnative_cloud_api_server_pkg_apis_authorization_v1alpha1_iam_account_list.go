...
// ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList struct for ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList
type ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList struct {
	// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	ApiVersion *string `json:"apiVersion,omitempty"`
	Items []ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount `json:"items"`
...
func NewComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList(items []ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount) *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList {
	this := ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList{}
	this.Items = items
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) GetItems() []ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount {
	if o == nil {
		var ret []ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccount
		return ret
	}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) Get() *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) Set(val *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList(val *ComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisAuthorizationV1alpha1IamAccountList) UnmarshalJSON(src []byte) error {
	v.isSet = true
