...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance Instance
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance struct {
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance{}
	return &this
}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha1Instance) UnmarshalJSON(src []byte) error {
	v.isSet = true
