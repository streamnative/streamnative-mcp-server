...
// ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription AWSSubscription
type ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription struct {
	...
	Spec *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionSpec `json:"spec,omitempty"`
	Status *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionStatus `json:"status,omitempty"`
}
...
func NewComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription {
	this := ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription{}
	return &this
}
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) GetSpec() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionSpec {
	if o == nil || o.Spec == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionSpec
		return ret
	}
	return *o.Spec
}
...
// SetSpec gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionSpec and assigns it to the Spec field.
...
func (o *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) GetStatus() ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionStatus {
	if o == nil || o.Status == nil {
		var ret ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionStatus
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscriptionStatus and assigns it to the Status field.
...
func (o ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) Get() *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) Set(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription(val *ComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisCloudV1alpha2AWSSubscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
