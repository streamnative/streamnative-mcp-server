...
func NewIoK8sApimachineryPkgApisMetaV1ListMeta() *IoK8sApimachineryPkgApisMetaV1ListMeta {
	this := IoK8sApimachineryPkgApisMetaV1ListMeta{}
	return &this
}
...
func (o IoK8sApimachineryPkgApisMetaV1ListMeta) MarshalJSON() ([]byte, error) {
...
type NullableIoK8sApimachineryPkgApisMetaV1ListMeta struct {
	value *IoK8sApimachineryPkgApisMetaV1ListMeta
	isSet bool
}

func (v NullableIoK8sApimachineryPkgApisMetaV1ListMeta) Get() *IoK8sApimachineryPkgApisMetaV1ListMeta {
	return v.value
}

func (v *NullableIoK8sApimachineryPkgApisMetaV1ListMeta) Set(val *IoK8sApimachineryPkgApisMetaV1ListMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableIoK8sApimachineryPkgApisMetaV1ListMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableIoK8sApimachineryPkgApisMetaV1ListMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIoK8sApimachineryPkgApisMetaV1ListMeta(val *IoK8sApimachineryPkgApisMetaV1ListMeta) *NullableIoK8sApimachineryPkgApisMetaV1ListMeta {
	return &NullableIoK8sApimachineryPkgApisMetaV1ListMeta{value: val, isSet: true}
}

func (v NullableIoK8sApimachineryPkgApisMetaV1ListMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIoK8sApimachineryPkgApisMetaV1ListMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
