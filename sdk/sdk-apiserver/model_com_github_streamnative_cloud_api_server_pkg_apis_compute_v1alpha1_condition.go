...
func NewComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition(status string, type_ string) *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition {
	this := ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition{}
	this.Status = status
	this.Type = type_
	return &this
}
...
func (o ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) MarshalJSON() ([]byte, error) {
...
type NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition struct {
	value *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition
	isSet bool
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) Get() *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition {
	return v.value
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) Set(val *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) {
	v.value = val
	v.isSet = true
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) IsSet() bool {
	return v.isSet
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition(val *ComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition {
	return &NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition{value: val, isSet: true}
}

func (v NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComGithubStreamnativeCloudApiServerPkgApisComputeV1alpha1Condition) UnmarshalJSON(src []byte) error {
	v.isSet = true
