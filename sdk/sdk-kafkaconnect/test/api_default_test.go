...
func Test_kafkaconnect_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService AlterConnectorOffsets", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DefaultAPI.AlterConnectorOffsets(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService PauseConnectorV2", func(t *testing.T) {
		...
		httpRes, err := apiClient.DefaultAPI.PauseConnectorV2(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService ResetConnectorActiveTopicsV2", func(t *testing.T) {
		...
		httpRes, err := apiClient.DefaultAPI.ResetConnectorActiveTopicsV2(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService ResetConnectorOffsets", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DefaultAPI.ResetConnectorOffsets(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService RestartConnector", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DefaultAPI.RestartConnector(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService RestartConnectorV2", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.DefaultAPI.RestartConnectorV2(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService ResumeConnectorV2", func(t *testing.T) {
		...
		httpRes, err := apiClient.DefaultAPI.ResumeConnectorV2(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService StopConnectorV2", func(t *testing.T) {
		...
		httpRes, err := apiClient.DefaultAPI.StopConnectorV2(context.Background(), connector).Execute()
	...
	t.Run("Test DefaultAPIService ValidateConfigs", func(t *testing.T) {
		...
		httpRes, err := apiClient.DefaultAPI.ValidateConfigs(context.Background(), pluginName).Execute()
