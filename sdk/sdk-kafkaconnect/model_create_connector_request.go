...
// GetInitialStateOk returns a tuple with the InitialState field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o CreateConnectorRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InitialState) {
		toSerialize["initial_state"] = o.InitialState
	}
	if !IsNil(o.Name) {
