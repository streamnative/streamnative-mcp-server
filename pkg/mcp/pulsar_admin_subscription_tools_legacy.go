...
// PulsarAdminAddSubscriptionToolsLegacy registers Pulsar admin subscription tools for the legacy server.
func PulsarAdminAddSubscriptionToolsLegacy(s *server.MCPServer, readOnly bool, features []string) {
