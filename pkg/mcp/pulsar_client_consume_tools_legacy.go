...
// PulsarClientAddConsumerToolsLegacy adds Pulsar client consumer tools to the legacy MCP server.
func PulsarClientAddConsumerToolsLegacy(s *server.MCPServer, readOnly bool, features []string) {
