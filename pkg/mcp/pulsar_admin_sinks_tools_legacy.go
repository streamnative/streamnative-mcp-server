...
// PulsarAdminAddSinksToolsLegacy registers Pulsar admin sink tools for the legacy server.
func PulsarAdminAddSinksToolsLegacy(s *server.MCPServer, readOnly bool, features []string) {
