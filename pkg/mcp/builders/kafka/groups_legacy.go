...
// KafkaGroupsLegacyToolBuilder implements the ToolBuilder interface for Kafka Consumer Groups.
type KafkaGroupsLegacyToolBuilder struct { //nolint:revive
	*builders.BaseToolBuilder
}

// NewKafkaGroupsLegacyToolBuilder creates a new legacy Kafka Groups tool builder instance.
func NewKafkaGroupsLegacyToolBuilder() *KafkaGroupsLegacyToolBuilder {
	...
	return &KafkaGroupsLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Kafka Groups tool list for the legacy server.
func (b *KafkaGroupsLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *KafkaGroupsLegacyToolBuilder) buildKafkaGroupsTool() mcp.Tool {
...
func (b *KafkaGroupsLegacyToolBuilder) buildKafkaGroupsHandler(readOnly bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *KafkaGroupsLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *KafkaGroupsLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
...
func (b *KafkaGroupsLegacyToolBuilder) handleKafkaGroupsList(ctx context.Context, admin *kadm.Client, _ mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *KafkaGroupsLegacyToolBuilder) handleKafkaGroupDescribe(ctx context.Context, admin *kadm.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *KafkaGroupsLegacyToolBuilder) handleKafkaGroupRemoveMembers(ctx context.Context, admin *kadm.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	groupName, err := request.RequireString("group")
	if err != nil {
		return b.handleError("get group name", err), nil
	}
...
func (b *KafkaGroupsLegacyToolBuilder) handleKafkaGroupOffsets(ctx context.Context, admin *kadm.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	groupName, err := request.RequireString("group")
	if err != nil {
		return b.handleError("get group name", err), nil
	}
...
func (b *KafkaGroupsLegacyToolBuilder) handleKafkaGroupDeleteOffset(ctx context.Context, admin *kadm.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	groupName, err := request.RequireString("group")
	if err != nil {
		return b.handleError("get group name", err), nil
	}
...
func (b *KafkaGroupsLegacyToolBuilder) handleKafkaGroupSetOffset(ctx context.Context, admin *kadm.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	groupName, err := request.RequireString("group")
	if err != nil {
		return b.handleError("get group name", err), nil
	}
