...
// KafkaProduceLegacyToolBuilder implements the legacy ToolBuilder interface for Kafka client produce operations.
// /nolint:revive
type KafkaProduceLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewKafkaProduceLegacyToolBuilder creates a new legacy Kafka produce tool builder instance.
func NewKafkaProduceLegacyToolBuilder() *KafkaProduceLegacyToolBuilder {
	...
	return &KafkaProduceLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Kafka produce tool list for the legacy server.
func (b *KafkaProduceLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *KafkaProduceLegacyToolBuilder) buildKafkaProduceTool() mcp.Tool {
...
func (b *KafkaProduceLegacyToolBuilder) buildKafkaProduceHandler() func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *KafkaProduceLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *KafkaProduceLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
