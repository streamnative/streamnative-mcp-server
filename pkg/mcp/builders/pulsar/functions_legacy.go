...
// PulsarAdminFunctionsLegacyToolBuilder implements the ToolBuilder interface for Pulsar admin functions operations
// It provides functionality to build Pulsar functions management tools
// /nolint:revive
type PulsarAdminFunctionsLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewPulsarAdminFunctionsLegacyToolBuilder creates a new Pulsar admin functions tool builder instance
func NewPulsarAdminFunctionsLegacyToolBuilder() *PulsarAdminFunctionsLegacyToolBuilder {
	...
	return &PulsarAdminFunctionsLegacyToolBuilder{
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) buildPulsarAdminFunctionsTool() mcp.Tool {
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) buildPulsarAdminFunctionsHandler(readOnly bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionList(_ context.Context, client cmdutils.Client, tenant, namespace string) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionGet(_ context.Context, client cmdutils.Client, tenant, namespace, name string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionStatus(_ context.Context, client cmdutils.Client, tenant, namespace, name string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionStats(_ context.Context, client cmdutils.Client, tenant, namespace, name string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionQuerystate(_ context.Context, client cmdutils.Client, tenant, namespace, name, key string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionCreate(_ context.Context, client cmdutils.Client, tenant, namespace, name string, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionUpdate(_ context.Context, client cmdutils.Client, tenant, namespace, name string, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionDelete(_ context.Context, client cmdutils.Client, tenant, namespace, name string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionStart(_ context.Context, client cmdutils.Client, tenant, namespace, name string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionStop(_ context.Context, client cmdutils.Client, tenant, namespace, name string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionRestart(_ context.Context, client cmdutils.Client, tenant, namespace, name string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionPutstate(_ context.Context, client cmdutils.Client, tenant, namespace, name, key, value string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleFunctionTrigger(_ context.Context, client cmdutils.Client, tenant, namespace, name, triggerValue, topic string) (*mcp.CallToolResult, error) {
	admin := client.Functions()
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) buildFunctionConfig(tenant, namespace, name string, request mcp.CallToolRequest, isUpdate bool) (*utils.FunctionConfig, error) {
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *PulsarAdminFunctionsLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
