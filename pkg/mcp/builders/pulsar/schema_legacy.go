...
// PulsarAdminSchemaLegacyToolBuilder implements the legacy ToolBuilder interface for Pulsar Admin Schema tools.
// It provides functionality to build Pulsar schema management tools for the legacy server.
// /nolint:revive
type PulsarAdminSchemaLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewPulsarAdminSchemaLegacyToolBuilder creates a new Pulsar Admin Schema legacy tool builder instance.
func NewPulsarAdminSchemaLegacyToolBuilder() *PulsarAdminSchemaLegacyToolBuilder {
	...
	return &PulsarAdminSchemaLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Pulsar Admin Schema tool list for the legacy server.
func (b *PulsarAdminSchemaLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *PulsarAdminSchemaLegacyToolBuilder) buildSchemaTool() mcp.Tool {
...
func (b *PulsarAdminSchemaLegacyToolBuilder) buildSchemaHandler(readOnly bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminSchemaLegacyToolBuilder) prettyPrint(data []byte) ([]byte, error) {
...
func (b *PulsarAdminSchemaLegacyToolBuilder) handleSchemaGet(admin cmdutils.Client, topic string, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminSchemaLegacyToolBuilder) handleSchemaUpload(admin cmdutils.Client, topic string, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminSchemaLegacyToolBuilder) handleSchemaDelete(admin cmdutils.Client, topic string) (*mcp.CallToolResult, error) {
	// Delete the schema
