...
// PulsarAdminTopicLegacyToolBuilder implements the ToolBuilder interface for Pulsar Admin Topic tools.
// It provides functionality to build Pulsar topic management tools for the legacy server.
// /nolint:revive
type PulsarAdminTopicLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewPulsarAdminTopicLegacyToolBuilder creates a new Pulsar Admin Topic legacy tool builder instance.
func NewPulsarAdminTopicLegacyToolBuilder() *PulsarAdminTopicLegacyToolBuilder {
	...
	return &PulsarAdminTopicLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Pulsar Admin Topic tool list for the legacy server.
func (b *PulsarAdminTopicLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *PulsarAdminTopicLegacyToolBuilder) buildTopicTool() mcp.Tool {
...
func (b *PulsarAdminTopicLegacyToolBuilder) buildTopicHandler(readOnly bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *PulsarAdminTopicLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicsList(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicGet(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicStats(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicLookup(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicCreate(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicDelete(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicUnload(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicTerminate(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicCompact(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicInternalStats(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicInternalInfo(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicBundleRange(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicLastMessageID(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicStatus(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicUpdate(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicOffload(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
...
func (b *PulsarAdminTopicLegacyToolBuilder) handleTopicOffloadStatus(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	// Get required parameters
	topic, err := request.RequireString("topic")
	if err != nil {
