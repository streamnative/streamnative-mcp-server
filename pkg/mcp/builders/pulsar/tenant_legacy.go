...
// PulsarAdminTenantLegacyToolBuilder implements the legacy ToolBuilder interface for Pulsar Admin Tenant tools.
// /nolint:revive
type PulsarAdminTenantLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewPulsarAdminTenantLegacyToolBuilder creates a new Pulsar Admin Tenant legacy tool builder instance.
func NewPulsarAdminTenantLegacyToolBuilder() *PulsarAdminTenantLegacyToolBuilder {
	...
	return &PulsarAdminTenantLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Pulsar Admin Tenant tool list.
func (b *PulsarAdminTenantLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *PulsarAdminTenantLegacyToolBuilder) buildTenantTool() mcp.Tool {
	...
	return mcp.NewTool("pulsar_admin_tenant",
		...
		mcp.WithString("resource", mcp.Required(),
			mcp.Description(pulsarAdminTenantResourceDesc),
		),
		mcp.WithString("operation", mcp.Required(),
			mcp.Description(pulsarAdminTenantOperationDesc),
		),
		mcp.WithString("tenant",
			mcp.Description(pulsarAdminTenantNameDesc),
		),
		mcp.WithArray("adminRoles",
			mcp.Description(pulsarAdminTenantAdminRolesDesc),
			mcp.Items(
		...
		mcp.WithArray("allowedClusters",
			mcp.Description(pulsarAdminTenantAllowedClustersDesc),
			mcp.Items(
				map[string]interface{}{
					"type":        "string",
					"description": "cluster",
...
func (b *PulsarAdminTenantLegacyToolBuilder) buildTenantHandler(readOnly bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminTenantLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *PulsarAdminTenantLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminTenantLegacyToolBuilder) handleTenantsList(admin cmdutils.Client) (*mcp.CallToolResult, error) {
	// Get tenants list
...
func (b *PulsarAdminTenantLegacyToolBuilder) handleTenantGet(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminTenantLegacyToolBuilder) handleTenantCreate(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	tenant, err := request.RequireString("tenant")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get tenant name: %v", err)), nil
	}
...
func (b *PulsarAdminTenantLegacyToolBuilder) handleTenantUpdate(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	tenant, err := request.RequireString("tenant")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get tenant name: %v", err)), nil
	}
...
func (b *PulsarAdminTenantLegacyToolBuilder) handleTenantDelete(admin cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	tenant, err := request.RequireString("tenant")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get tenant name: %v", err)), nil
	}
