...
// PulsarClientProduceLegacyToolBuilder implements the legacy ToolBuilder interface for Pulsar Client Producer tools.
// /nolint:revive
type PulsarClientProduceLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewPulsarClientProduceLegacyToolBuilder creates a new legacy Pulsar Client Producer tool builder instance.
func NewPulsarClientProduceLegacyToolBuilder() *PulsarClientProduceLegacyToolBuilder {
	...
	return &PulsarClientProduceLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Pulsar Client Producer tool list for the legacy server.
func (b *PulsarClientProduceLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *PulsarClientProduceLegacyToolBuilder) buildProduceTool() mcp.Tool {
...
func (b *PulsarClientProduceLegacyToolBuilder) buildProduceHandler(readOnly bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarClientProduceLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *PulsarClientProduceLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
...
func (b *PulsarClientProduceLegacyToolBuilder) generateMessagePayloads(messages []string) ([][]byte, error) {
	var payloads [][]byte
...
func (b *PulsarClientProduceLegacyToolBuilder) parseProperties(properties []string) (map[string]string, error) {
