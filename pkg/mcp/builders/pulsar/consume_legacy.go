...
// PulsarClientConsumeLegacyToolBuilder implements the legacy ToolBuilder interface for Pulsar Client Consumer tools.
// /nolint:revive
type PulsarClientConsumeLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewPulsarClientConsumeLegacyToolBuilder creates a new legacy Pulsar Client Consumer tool builder instance.
func NewPulsarClientConsumeLegacyToolBuilder() *PulsarClientConsumeLegacyToolBuilder {
	...
	return &PulsarClientConsumeLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Pulsar Client Consumer tool list for the legacy server.
func (b *PulsarClientConsumeLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *PulsarClientConsumeLegacyToolBuilder) buildConsumeTool() mcp.Tool {
...
func (b *PulsarClientConsumeLegacyToolBuilder) buildConsumeHandler(_ bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarClientConsumeLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *PulsarClientConsumeLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
