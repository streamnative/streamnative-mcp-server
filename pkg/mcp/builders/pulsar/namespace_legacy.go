...
// PulsarAdminNamespaceLegacyToolBuilder implements the ToolBuilder interface for Pulsar Admin Namespace tools
// It provides functionality to build Pulsar namespace management tools for the legacy server
// /nolint:revive
type PulsarAdminNamespaceLegacyToolBuilder struct {
	*builders.BaseToolBuilder
}

// NewPulsarAdminNamespaceLegacyToolBuilder creates a new Pulsar Admin Namespace legacy tool builder instance
func NewPulsarAdminNamespaceLegacyToolBuilder() *PulsarAdminNamespaceLegacyToolBuilder {
	...
	return &PulsarAdminNamespaceLegacyToolBuilder{
		BaseToolBuilder: builders.NewBaseToolBuilder(metadata, features),
	}
}

// BuildTools builds the Pulsar Admin Namespace tool list for the legacy server
// This is the core method implementing the ToolBuilder interface
func (b *PulsarAdminNamespaceLegacyToolBuilder) BuildTools(_ context.Context, config builders.ToolBuildConfig) ([]server.ServerTool, error) {
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) buildNamespaceTool() mcp.Tool {
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) buildNamespaceHandler(readOnly bool) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleError(operation string, err error) *mcp.CallToolResult {
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) marshalResponse(data interface{}) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleNamespaceList(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleNamespaceGetTopics(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleNamespaceCreate(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	namespace, err := request.RequireString("namespace")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get namespace name: %v", err)), nil
	}
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleNamespaceDelete(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	namespace, err := request.RequireString("namespace")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get namespace name: %v", err)), nil
	}
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleClearBacklog(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	namespace, err := request.RequireString("namespace")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get namespace name: %v", err)), nil
	}
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleUnsubscribe(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	namespace, err := request.RequireString("namespace")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get namespace name: %v", err)), nil
	}
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleUnload(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	namespace, err := request.RequireString("namespace")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get namespace name: %v", err)), nil
	}
...
func (b *PulsarAdminNamespaceLegacyToolBuilder) handleSplitBundle(_ context.Context, client cmdutils.Client, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	namespace, err := request.RequireString("namespace")
	if err != nil {
		return mcp.NewToolResultError(fmt.Sprintf("Failed to get namespace name: %v", err)), nil
	}
