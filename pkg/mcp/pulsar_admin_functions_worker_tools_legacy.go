...
// PulsarAdminAddFunctionsWorkerToolsLegacy adds functions worker-related tools to the legacy MCP server.
func PulsarAdminAddFunctionsWorkerToolsLegacy(s *server.MCPServer, readOnly bool, features []string) {
