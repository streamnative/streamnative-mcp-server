...
// NewDefaultClientCredentialsFlowWithKeyFileStruct provides an easy way to build up a default
// client credentials flow with all the correct configuration.
func NewDefaultClientCredentialsFlowWithKeyFileStruct(issuerData Issuer, keyFile *KeyFile) (*ClientCredentialsFlow, error) {
	...
	credsProvider := NewClientCredentialsProviderFromKeyFileStruct(keyFile)
