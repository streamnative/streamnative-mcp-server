#### pulsar_admin_resourcequota_read / pulsar_admin_resourcequota_write


<!-- generated:operations:start -->
| Tool | Mode | Operations |
|---|---|---|
| `pulsar_admin_resourcequota_read` | read | `get` |
| `pulsar_admin_resourcequota_write` | write | `set`, `reset` |
